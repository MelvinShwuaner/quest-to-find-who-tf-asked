...
class MainGame : JPanel(), Runnable {
    ...
    fun displayScreen() {
        if (GlobalGameThreadConfigs.g2 != null) {
            ...
            if(GlobalGameThreadConfigs.dark)
              tilemanager.drawSKY(GlobalGameThreadConfigs.g2)
            ...
            if (KeyHandler.checkFPS && GlobalGameThreadConfigs.GameState == GlobalGameThreadConfigs.PlayState) {
                ...
                GlobalGameThreadConfigs.g2.drawString("World: $currentmap", 10, 240)
                GlobalGameThreadConfigs.g2.drawString("Z: ${player.worldz}", 10, 180)
                GlobalGameThreadConfigs.g2.drawString(
    ...
    companion object {
        ...
        const val maxworldlayer = 8
         ...
         @JvmStatic
        fun setupOBJ() {
             GlobalGameThreadConfigs.lights = Array(maxmap) {
                 arrayOfNulls(
                     100
                 )
             }
