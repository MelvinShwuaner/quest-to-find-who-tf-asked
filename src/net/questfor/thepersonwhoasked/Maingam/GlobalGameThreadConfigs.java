...
import net.questfor.thepersonwhoasked.World.enviormentmanager;
...
public class GlobalGameThreadConfigs extends Data {
    ...
    public static Light[][] lights = new Light[MainGame.maxmap][100];
    public static enviormentmanager Emanager = new enviormentmanager(gp);
