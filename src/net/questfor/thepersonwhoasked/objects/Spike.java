...
public class Spike extends LivingEntity {
    public Spike(MainGame gp){
        super(gp);
    ...
    public void getImageInstance() {
        down1 = BufferedRenderer("shredderup.", GlobalGameThreadConfigs.tilesize-2, GlobalGameThreadConfigs.tilesize-5);
    }
